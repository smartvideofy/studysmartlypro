  ...
  return (
    <ResponsiveModal open={open} onOpenChange={onOpenChange}>
      ...
      <ResponsiveModalBody className="space-y-6">
        {/* Create New Invite */}
        <div className="space-y-4 p-3 md:p-4 border border-border rounded-lg bg-secondary/30">
              ...
              {invites.map((invite) => (
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 md:gap-3 mt-1 text-[10px] md:text-xs text-muted-foreground">
